...
<body>
    ...
    <div class="preview-topbar">
        <a href="<?php echo ($back_button_link ? esc_url($back_button_link): '../'); ?>" class="back-btn">
        ...
        <a class="buy-btn btn btn-secondary" href="<?php echo esc_url($buynow_button_url) ?>"><?php echo esc_html($buynow_button_text); ?></a>
    </div>
    <!-- Preview Top Bar End -->
